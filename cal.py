"""
Модуль для расчета государственной пошлины в арбитражных судах.
"""

from typing import Dict, Union


def calculate_duty(total_sum: Union[float, int]) -> Dict[str, Union[int, str]]:
    """
    Рассчитывает государственную пошлину для арбитражного суда.

    Args:
        total_sum: Сумма иска в рублях

    Returns:
        Словарь с суммой пошлины и формулой расчета или ошибкой
    ...
    if y <= 100000:
        ...
        formula = (
            "свыше 50 000 000 рублей - 725 000 рублей плюс 0,5 процента "
            "суммы, превышающей 50 000 000 рублей"
        )
        if res > 10000000:
            res = 10000000
            formula = (
                "свыше 50 000 000 рублей - максимум 10 000 000 рублей"
            )
